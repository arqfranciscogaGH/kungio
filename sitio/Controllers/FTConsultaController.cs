...
namespace Sitio.Controllers
{
    public class FTConsultaController : ApiController
    {
        ...
        //http://localhost:50954/api/FTConsulta/LINEAIV/''/1/ConsultarMisPendientes/prueba
        // http://localhost:50954/api/FTConsulta/LINEAIV/''/1/VerProductividadVencidasdDetalle/prueba
        // http://localhost:50954/api/FTConsulta/LINEAIV/''/1/VerTramite/prueba
        // http://localhost:50954/api/FTConsulta/LINEAIV/''/1/VerEstadisticasFlujoPorVista/prueba

        // http://kungio.mx/api/FTConsulta/LINEAIV/''/1/VerEstadisticasFlujoPorVista/prueba



        // http://kungio.mx/api/FTConsulta/LINEAIV/''/1/VerEstadisticasFlujoPorVistaDetallePorFiltro/prueba
        // http://localhost:50954/api/FTConsulta/LINEAIV/''/1/VerEstadisticasFlujoPorVistaDetallePorFiltro/prueba

        // http://localhost:50954/api/FTConsulta/LINEAIV/''/1/VerProductividadVencidas/prueba


        // http://kungio.mx/api/FTConsulta/LINEAIV/''/1/VerProductividadVencidas/prueba
        // http://kungio.mx/api/FTConsulta/LINEAIV/''/1/VerProductividadVencidasdDetalle/prueba
        // http://kungio.mx/api/FTConsulta/LINEAIV/''/1/VerTramite/prueba

        //http://localhost:50954/api/FTConsulta/LINEAIV/100/1/Seguimiento/prueba
        //http://localhost:50954/api/FTConsulta/LINEAIV/004/1/ConsultarHistorial/prueba

        //http://localhost:50954/api/FTConsulta/LINEAIV/''/1/VerEstadisticasFlujoTrabajoPorTarea/prueba
        //http://localhost:50954/api/FTConsulta/LINEAIV/''/1/VerEstadisticasFlujoTrabajoPorEstatus/prueba
        //http://localhost:50954/api/FTConsulta/LINEAIV/''/1/VerEstadisticasTrabajoPorEstatusHistorial/prueba
        //http://localhost:50954/api/FTConsulta/LINEAIV/''/1/VerProductividadPorTarea/prueba

        //http://localhost:50954/api/FTConsulta/LINEAIV/19/1/prueba/VerlujoTrabajoPorTareaDetalle/prueba
        //http://localhost:50954/api/FTConsulta/LINEAIV/19/1/prueba/VerProductividadPorTareaDetalle/prueba
